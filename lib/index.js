...
import length7 from "../data/appendixD/alphabetizedByLength/7.json";
import length8 from "../data/appendixD/alphabetizedByLength/8.json";
import length9 from "../data/appendixD/alphabetizedByLength/9.json";
import length10 from "../data/appendixD/alphabetizedByLength/10.json";
import length11 from "../data/appendixD/alphabetizedByLength/11.json";
import length12 from "../data/appendixD/alphabetizedByLength/12.json";
import length13 from "../data/appendixD/alphabetizedByLength/13.json";
import length14 from "../data/appendixD/alphabetizedByLength/14.json";
